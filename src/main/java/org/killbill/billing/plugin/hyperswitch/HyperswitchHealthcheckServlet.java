...
@Singleton
@Path("/healthcheck")
public class HyperswitchHealthcheckServlet extends PluginHealthcheck {

    private final HyperswitchHealthcheck healthcheck;

    @Inject
    public HyperswitchHealthcheckServlet(final HyperswitchHealthcheck healthcheck) {
